...
public class TransactionController {
    ...
    public String add(@RequestParam Long accountId,
        ...
        if (Assistant.isUserAccount(dbUser(), account)
            ...
            addTransaction(transaction, account, exchange, exchangeAccount, currency, customer, entry);
        }
    ...
    public String add(@RequestParam Long accountOutId,
        ...
        if (Assistant.isUserAccount(dbUser(), accountIn)
            ...
            addTransaction(transactionIn, accountOut, exchange, exchangeAccountOut, currency, customer, entry);
            addTransaction(transactionOut, accountIn, exchange, exchangeAccountIn, currency, customer, entry);
        }
    ...
    private void updateAccountSum(Account account, Exchange exchange, Exchange exchangeAccount, Double plus, Double minus) {
    ...
    private void addTransaction(Transaction transaction,
                                ...
                                Customer customer,
                                Entry entry) {
        updateAccountSum(account, exchange, exchangeAccount, transaction.getSumIn(), transaction.getSumOut());
